...
class EstimatesControllerTest < ActionController::TestCase
  ...
  test "should create estimate" do
    assert_difference('Estimate.count') do
      post :create, estimate: { customer_id: @estimate.customer_id, description: @estimate.description, potential_customer: @estimate.potential_customer, quantity: @estimate.quantity, terms: @estimate.terms, total: @estimate.total }
    end
  ...
  test "should update estimate" do
    patch :update, id: @estimate, estimate: { customer_id: @estimate.customer_id, description: @estimate.description, potential_customer: @estimate.potential_customer, quantity: @estimate.quantity, terms: @estimate.terms, total: @estimate.total }
    assert_redirected_to estimate_path(assigns(:estimate))
  end
